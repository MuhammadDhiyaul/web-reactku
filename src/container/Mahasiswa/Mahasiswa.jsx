...
class Mahasiswa extends Component {
    ...
    ambilDataDariServerAPI = () => {
        fetch('http://localhost:3020/mahasiswa?_sort=id&_order=desc') // alamat URL API yang ingin kita ambil datanya
    ...
    handleHapus = (data) => {
        fetch(`http://localhost:3020/mahasiswa/${data}`, { method: 'DELETE' })
            .then(res => {
                this.ambilDataDariServerAPI()
            })
    }
    ...
    handleTombolSimpan = () => {
        fetch('http://localhost:3020/mahasiswa', {
            method: 'POST',
            headers: {
